...
vcftools --vcf ${1} --maf 0.05 --recode --out ${2}_maf0.05

# Add 'chr' to start of chromosome number in vcf file
awk '{if($0 !~ /^#/) print "chr"$0; else print $0}' ${2}_maf0.05.recode.vcf > ${2}_maf0.05.recode.vcf.TMP
mv ${2}_maf0.05.recode.vcf.TMP  ${2}_maf0.05.recode.vcf
...
vcftools --vcf ${2}_maf0.05.recode.vcf --keep ref_panel.list --recode --out ${2}_ref_panel
vcftools --vcf ${2}_maf0.05.recode.vcf --keep focal.list --recode --out ${2}_focal
