...
\href{http://alanrogers.github.io/legofit/html/index.html#lgo}{legofit
  ...
  \item[\texttt{a1.slr}}] is a script, which can be interpreted by
    ``slurm,'' a program that manages jobs on a compute cluster. Have
    a look at this file. Rather than executing it on the cluster,
    start with a similar analysis on your own computer.
\end{description}    
